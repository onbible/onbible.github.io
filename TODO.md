...
- [x] **Modo "Pregação/Púlpito":** Uma interface limpa, de altíssimo contraste, onde o pastor aperta um botão que esconde temporariamente botões extras/notificações e deixa 100% da tela ocupada pela palavra.